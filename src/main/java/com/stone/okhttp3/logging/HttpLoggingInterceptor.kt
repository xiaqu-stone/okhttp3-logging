 ...
 */
package com.stone.okhttp3.logging
...
class HttpLoggingInterceptor @JvmOverloads constructor(private val logger: Logger = Logger.DEFAULT) : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        logger.log("==================Start Request Logging======================================================================")
        ...
        logger.log("==================END Request Logging======================================================================")
        ...
        if (logHeaders) {
            ...
            if (!logBody || !HttpHeaders.hasBody(response)) {
                ...
                if (contentLength != 0L) {
                    ...
                    Logs.json("OkHttp", readString, response.request().url().toString())
                }
